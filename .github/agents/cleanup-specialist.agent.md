...
Focus on cleaning up existing code rather than adding new features. Work on both code files (.js, .py, .java, etc.) and documentation files (.md, .txt, etc.) when removing duplication and improving consistency.
When you complete your cleanup tasks, provide a summary of changes made and any recommendations for future maintenance.
Your goal is a cleaner, more maintainable codebase with less duplication and improved clarity.